          ...
          >
            ...
            <div className="bg-card rounded-2xl p-8 shadow-card">
              <p className="text-lg text-foreground mb-6 leading-relaxed">
                <span className="text-2xl">🙏</span> Sawadee ka! I'm Ying. I started this van service to show 
                travelers the Chiang Mai I love. When I'm not driving guests around the mountains, 
                I'm making travel videos on Instagram and TikTok for my community of more than 
            ...
            <div className="bg-card rounded-2xl p-6 shadow-card">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-foreground">@yingchiangmai</p>
