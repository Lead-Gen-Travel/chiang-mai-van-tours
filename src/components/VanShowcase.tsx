...
const amenities = ["Complimentary cold water", "Phone charging ports", "Tinted windows for privacy", "Luggage space for day bags", "Clean and sanitized daily", "Child seats available on request"];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          once: true
            ...
            <div className="col-span-2">
              <img src={vanExterior} alt="White Toyota van exterior at scenic mountain viewpoint" className="w-full h-64 md:h-80 object-cover rounded-2xl shadow-card" />
            </div>
            <div className="col-span-2">
              <img alt="Spacious clean van interior with leather seats" className="w-full h-48 md:h-56 object-cover rounded-2xl shadow-card" src="/lovable-uploads/8e96a35e-f324-4282-bb34-33dcb51b348e.jpg" />
            </div>
          </motion.div>
          ...
          once: true
            ...
            <div className="bg-card p-6 rounded-xl shadow-card">
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                {amenities.map(amenity => <div key={amenity} className="flex items-center gap-2 text-sm text-muted-foreground">
